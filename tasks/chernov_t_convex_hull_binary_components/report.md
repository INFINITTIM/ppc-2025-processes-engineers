...
- Функциональные тесты: 5 случаев — пустое изображение, одна точка, диагональ, квадрат 2 на 2, два квадрата.
...
Все функциональные тесты успешно пройдены как для SEQ, так и для MPI-реализации. Результаты совпадают по покрытию точек выпуклых оболочек. Тесты охватывают:
